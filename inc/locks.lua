...
redis:del(Alamy..'lock_id'..msg.chat_id_) 
return "❀ **أهلاً عزيزي "..msg.TheRankCmd.."\n❀ **تم تعطيل امر الايدي\n" 
end 
end
...
if not msg.Director then return "❀ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n❀ " end
if redis:get(Alamy..':tqeed_video:'..msg.chat_id_) then
...
if not msg.Director then return "❀ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n❀ " end
if redis:get(Alamy..':tqeed_fwd:'..msg.chat_id_) then
...
redis:del(Alamy..':tqeed_fwd:'..msg.chat_id_)
...
if not msg.Director then return "❀ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n❀ " end
if redis:get(Alamy..':tqeed_link:'..msg.chat_id_) then
return '❀ **أهلاً عزيزي '..msg.TheRankCmd..'\n❀ **التقييد بالروابط بالتأكيد تم قفله \n'
else
redis:set(Alamy..':tqeed_link:'..msg.chat_id_,true)
...
if not msg.SudoBase then return "❀ **هذا الامر يخص المطور فقط  ❀ " end
if redis:get(Alamy..'lock_brod') then
...
redis:del(Alamy..'lock_join'..msg.chat_id_)
return '❀ **أهلاً عزيزي '..msg.TheRankCmd..'\n❀ **تم فتح الاضافه \n'
end
end
...
if not msg.Admin then return "❀ **هذا الامر يخص الادمنيه فقط  ❀ " end
if redis:get(Alamy..'mute_game'..msg.chat_id_) then
...
if not msg.Admin then return "❀ **هذا الامر يخص الادمنيه فقط  ❀ " end
if not redis:get(Alamy..'mute_game'..msg.chat_id_) then
return '❀ **أهلاً عزيزي '..msg.TheRankCmd..'\n❀ **الألعاب بالتأكيد تم فتحها \n'
else 
redis:del(Alamy..'mute_game'..msg.chat_id_)
return '❀ **أهلاً عزيزي '..msg.TheRankCmd..'\n❀ **تم فتح الألعاب \n'
end
end
---------------Mute Inline-------------------
