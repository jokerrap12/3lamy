...
local function iAlamy(msg,MsgText)
...
sendMsg(SUDO_ID,0,'💂🏻‍♀️│تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿\n🕵🏼️‍♀️│في مجموعه  » »  '..redis:get(Alamy..'group:name'..msg.chat_id_))
else
...
if MsgText[2] == '2' then
redis:setex(Alamy..'ExpireDate:'..msg.chat_id_,7776000,true)
if not redis:get(Alamy..'CheckExpire::'..msg.chat_id_) then 
redis:set(Alamy..'CheckExpire::'..msg.chat_id_,true) 
end
...
local check_time = redis:ttl(Alamy..'ExpireDate:'..msg.chat_id_)
...
function(arg,data)
if data.ID == "Ok" then
redis:set(Alamy..":MsgIDPin:"..msg.chat_id_,msg.reply_id)
...
if not msg.Director then return "❀ **هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n" end
local MKTOMEN = redis:scard(Alamy..'is_silent_users:'..msg.chat_id_)
if MKTOMEN ==0 then 
return "❀ ** لا يوجد مستخدمين مكتومين في المجموعه " 
end
redis:del(Alamy..'is_silent_users:'..msg.chat_id_)
...
redis:setex(Alamy..'photo:group'..msg.chat_id_..msg.sender_user_id_,300,true)
...
if redis:get(Alamy.."getidstatus"..msg.chat_id_) == "Photo" then
	if data.photos_[0] then 
		...
		sendPhoto(msg.chat_id_,msg.id_,data.photos_[0].sizes_[1].photo_.persistent_id_,'⋆ 𝚃𝙷𝙴 𝙽𝙰𝙼𝙴 ⇢ '..Namei..'     \n⋆ 𝚄𝚂𝙴𝚁 ⇢ '..UserNameID..' .\n⋆ 𝙼𝚂𝙶 ⇢  '..msgs..' .\n⋆ 𝚁𝙰𝙽𝙺 ⇢ '..msg.TheRank..' .\n⋆ 𝙸𝙳 ⇢ '..msg.sender_user_id_..' .',dl_cb,nil)
		else
...
redis:del(Alamy..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
...
redis:setex(Alamy..'welcom_ph:witting'..msg.sender_user_id_,300,true) 
...
redis:setex(Alamy..'text_sudo:witting'..msg.sender_user_id_,1200,true) 
...
local name_gp = redis:get(Alamy..'group:name'..MsgText[2])
...
if not msg.SudoBase then return "*│*هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request( 'https://raw.githubusercontent.com/mohamedadel-dev/AlamyFILE/main/GetVersion.txt' ) or 0
...
return '܁༯┆اصدار سورس العالمي: *v'..version..'* \n'
end
...
sendMsg(msg.chat_id_,msg.id_,'❀ ** عذراً اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس كساب يرجاء جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n')
end  
else
...
redis:del(Alamy..'replay:'..msg.chat_id_,Alamy..'replay_photo:group:'..msg.chat_id_,Alamy..'replay_voice:group:'..msg.chat_id_,
Alamy..'replay_animation:group:'..msg.chat_id_,Alamy..'replay_audio:group:'..msg.chat_id_,Alamy..'replay_sticker:group:'..msg.chat_id_,Alamy..'replay_video:group:'..msg.chat_id_)
...
if not msg.SudoBase then return"❀ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
redis:set(Alamy..'delrdall:'..msg.sender_user_id_,true) 
...
❀➪ م4 «» اوامر الخدمه 
❀➪ م5 «»  اوامر المطور
❀➪ .[قـنـاه الـسـورس](t.me/FlassTas10) 
❀➪ [ مـطـور الـسـورس ](t.me/Alamy3)
܀⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤⠤܀
...
❀    𝒔𝒐𝒖𝒓𝒄𝒆 𝒂𝒍𝒂𝒎𝒚 ♕
◄⠀━━━━𖦹━━━━⠀►
❀𝒅𝒆𝒗 >> [𝒅𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒓 𖡨 ](t.me/Alamy3)

❀𝒅𝒆𝒗 >> [𝒅𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒓 𖡨](t.me/XxxMalificentxxX)

❀𝒅𝒆𝒗 >> [𝒅𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒓 𖡨](t.me/mando22555)

❀𝒄𝒉 >> [𝑪𝑯𝑨𝑵𝑵𝑬𝑳 𝑨𝑳𝑨𝑴𝒀 𖡛“](t.me/FlassTas10)

❀𝒄𝒉 >> [𝑻𝑶 𝑻𝑨𝑳𝑲 𝑼𝑺 𖡨](t.me/FlassTas4_bot)
...
return '❀ **عدد سحكاتك ⇜ ❪ '..(redis:get(Alamy..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n'
end
...
if not msg.SudoBase then return"❀ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
if redis:get(Alamy..":UserNameChaneel") then
...
if not msg.SudoBase then return"❀ **هذا الامر يخص {المطور الاساسي} فقط  \n" end
local SubDel = redis:del(Alamy..":UserNameChaneel")
if SubDel == 1 then
...
local hash = Alamy..'user_names:'..msg.sender_user_id_
redis:set(hash,info)
end
...
redis:set(Alamy..'welc'..msg.chat_id_,'on')
end
end
...
if Alamy.content_.ID == "MessageSticker" then        
local bd = Alamy.content_.sticker_.sticker_.path_          
...
[قنـاة سورس العالمي ᪤](t.me/FlassTas10)
...
if redis:get(Alamy..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد لكل المجموعات
...
if redis:get(Alamy..'text_sudo:witting'..msg.sender_user_id_) then -- استقبال كليشه المطور
redis:del(Alamy..'text_sudo:witting'..msg.sender_user_id_) 
redis:set(Alamy..':TEXT_SUDO',Flter_Markdown(msg.text))
...
redis:del(Alamy..'fwd:all'..msg.sender_user_id_)
local pv = redis:smembers(Alamy..'users')  
local groups = redis:smembers(Alamy..'group:ids')
...
redis:del(Alamy..'fwd:pv'..msg.sender_user_id_)
local pv = redis:smembers(Alamy..'users')
if #pv >= 300 then
...
sendPhoto(msg.chat_id_,msg.id_,redis:get(Alamy..':WELCOME_BOT'),[[❀أهلاً انا بوت ]]..redis:get(Alamy..':NameBot:')..[[
...
redis:del(Alamy..'welcom_ph:witting'..msg.sender_user_id_)
...
welcome = (redis:get(Alamy..'welcome:msg'..msg.chat_id_) or "❀ اهلن بك عزيزي {الاسم}\n❀ معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n❀ اسم القروب » {المجموعه}")
if welcome then
rules = (redis:get(Alamy..'rulse:msg'..msg.chat_id_) or "❀ مرحباً عزيري القوانين كلاتي .\n❀ ممنوع نشر الروابط\n❀ ممنوع التكلم او نشر صور اباحيه\n❀ ممنوع  اعاده توجيه\n❀ ممنوع التكلم بالسياسة\n❀ الرجاء احترام المدراء والادمنيه\n")
welcome = welcome:gsub("{القوانين}", rules)
...
if tonumber(msgs) > tonumber(NUM_MSG_Alamy) then 
...
return false
elseif msg.sticker and redis:get(Alamy..'mute_sticker'..msg.chat_id_) then --قفل الملصقات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif Text== "العالمي" or Text== "حبيب الكل" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور السورس❀](https://t.me/Alamy3)")
elseif Text== "سام" or Text== "سامواري" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور السورس](https://t.me/XxxMalificentxxX)")
elseif Text== "محمد سمير" or Text== "سمير" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور سورس](https://t.me/mando22555)")
elseif Text== "هروين" or Text== "بتاع الترعه" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور السورس](https://t.me/mhzon1)")
elseif Text== "جوكر" or Text== "الجوكر راب" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور السورس](https://t.me/jokerrap1)")
...
return sendMsg(msg.chat_id_,msg.id_,"[انت المطور الغالي ♕](https://t.me/FlassTas10) ")
elseif msg.Creator then 
return sendMsg(msg.chat_id_,msg.id_,"[انت منشئ المجموعه  تاج راسي♔](https://FlassTas10)")
elseif msg.Director then 
return sendMsg(msg.chat_id_,msg.id_,"[انت مدير المجموعه๑](https://t.me/FlassTas10)")
elseif msg.Admin then 
return sendMsg(msg.chat_id_,msg.id_,"[انت ادمن شد حيلك♘](https://t.me/FlassTas10)")
else 
return sendMsg(msg.chat_id_,msg.id_,"[مجرد عضو ذليل𖦹](https://t.me/FlassTas10)")
end 
end 
...
if not redis:get('kar') then
  ...
  sendMsg(SUDO_ID,0,'❀ انتهى الاشتراك في احد المجموعات .\n❀ المجموعه : '..FlterName(redis:get(Alamy..'group:name'..msg.chat_id_))..'.\n❀ ايدي : '..msg.chat_id_)
